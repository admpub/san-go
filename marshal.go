...
// can marshal themselves into valid SAN.
type Marshaler interface {
	MarshalSAN() ([]byte, error)
}

/*
Marshal returns the SAN encoding of sata.  Behavior is similar to the Go json
...
// Convert given marshal struct or map value to san tree
...
func callCustomMarshaler(mval reflect.Value) ([]byte, error) {
	return mval.Interface().(Marshaler).MarshalSAN()
}
